...
public class ESellerListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upperbar_tv.setTypeface(setFontClass.getNotoSansBold());
        //////////////////////인텐트 통해서 아이디값 전달//////////////////////
        ...
        Toast.makeText(getApplicationContext(), category + ":" + thing_num + ":" + user_num + ":" + id, Toast.LENGTH_SHORT).show();
        ////////////////////////ListView & Adapter////////////////////////
    ...
    public class CheckOkDialog extends Dialog implements DialogInterface.OnClickListener {
        ...
        public CheckOkDialog() {
            ...
            ///////////////////폰트설정/////////////////////////////
            okButton.setTypeface(setFontClass.getNotoSansRegular());
            cancelButton.setTypeface(setFontClass.getNotoSansRegular());
            text1.setTypeface(setFontClass.getNotoSansRegular());
            text2.setTypeface(setFontClass.getNotoSansRegular());
            ////////////////클릭 리스너//////////////////////////////
            okButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    int change_point = (demand_price_parse - info_price_parse) / 4;
                    ...
                    if (my_point - change_point >= 0 && change_point >= 0) {
                        ...
                        pointInfo.point = my_point - change_point;
                        Call<PointPayResult> putSellerChange = service.putPointChange(user_num, pointInfo);
    ...
    public class CheckFailDialog extends Dialog implements DialogInterface.OnClickListener {
        ...
        public CheckFailDialog() {
            ...
            text1.setTypeface(setFontClass.getNotoSansRegular());
            text2.setTypeface(setFontClass.getNotoSansRegular());
            text3.setTypeface(setFontClass.getNotoSansRegular());
            /////////////리스너등록/////////////
            okButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
...
//                        bundle_prod_info.putString("text2", response.body().result.category);
    ...
    public class EditDialog extends Dialog implements DialogInterface.OnClickListener {
        ...
        public EditDialog() {
            ...
            text1.setTypeface(setFontClass.getNotoSansRegular());
            text2.setTypeface(setFontClass.getNotoSansRegular());
            editButton.setTypeface(setFontClass.getNotoSansRegular());
            delButton.setTypeface(setFontClass.getNotoSansRegular());
            /////////////리스너등록/////////////
    ...
    public class EditCommentDialog extends Dialog implements DialogInterface.OnClickListener {
        ...
        public EditCommentDialog() {
            ...
            delButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (category.equals("전자제품")) {
                        Call<DeleteResult> deleteElec = service.deleteElecComment(thing_num);
                        deleteElec.enqueue(new Callback<DeleteResult>() {
                            @Override
                            public void onResponse(Call<DeleteResult> call, Response<DeleteResult> response) {
                                if (response.isSuccessful()) {
                        ...
                        Call<DeleteResult> deleteUtil = service.deleteUtilComment(thing_num);
                        deleteUtil.enqueue(new Callback<DeleteResult>() {
                            @Override
                            public void onResponse(Call<DeleteResult> call, Response<DeleteResult> response) {
                                if (response.isSuccessful()) {
                        ...
                        Call<DeleteResult> deleteBrand = service.deleteBrandComment(thing_num);
                        deleteBrand.enqueue(new Callback<DeleteResult>() {
                            @Override
                            public void onResponse(Call<DeleteResult> call, Response<DeleteResult> response) {
                                if (response.isSuccessful()) {
                        ...
                        Call<DeleteResult> deleteSmart = service.deleteSmartComment(thing_num);
                        deleteSmart.enqueue(new Callback<DeleteResult>() {
                            @Override
                            public void onResponse(Call<DeleteResult> call, Response<DeleteResult> response) {
                                if (response.isSuccessful()) {
                        ...
                        Call<DeleteResult> deleteEtc = service.deleteEtcComment(thing_num);
                        deleteEtc.enqueue(new Callback<DeleteResult>() {
                            @Override
                            public void onResponse(Call<DeleteResult> call, Response<DeleteResult> response) {
                                if (response.isSuccessful()) {
