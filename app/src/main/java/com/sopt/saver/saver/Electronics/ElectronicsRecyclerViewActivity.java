...
public class ElectronicsRecyclerViewActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    private RecyclerView recyclerView;
    private ArrayList<Electronics_ItemData> eDatas;
    private LinearLayoutManager mLayoutManager;
    private ElectronicsRecyclerAdapter adapter;
    ...
    private Electronics_ItemData edata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eDatas = new ArrayList<Electronics_ItemData>();

        ////////////////////////리사이클러 뷰와 어뎁터 연동////////////////////////
        ////////////////////////파라미터로 위의 ArrayList와 클릭이벤트////////////////////////
        adapter = new ElectronicsRecyclerAdapter(eDatas, clickEvent);
         ...
         */
        Call<Electronics_ItemResult> requestMainData = service.getElectronicsResult();
        requestMainData.enqueue(new Callback<Electronics_ItemResult>() {
            @Override
            public void onResponse(Call<Electronics_ItemResult> call, Response<Electronics_ItemResult> response) {
            ...
            @Override
            public void onFailure(Call<Electronics_ItemResult> call, Throwable t) {
