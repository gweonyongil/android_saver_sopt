...
public class MainViewPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainPageFragment.setAssetManager(getApplicationContext().getAssets());
        ...
        mydealFragment.setContext(getApplicationContext());
        mydealFragment.setAssetManager(getAssets());
