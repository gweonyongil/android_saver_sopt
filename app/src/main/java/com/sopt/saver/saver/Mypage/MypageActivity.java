...
public class MyPageActivity extends AppCompatActivity {
    ...
    ////////////////////////////////////////
    private TextView mypage_navi = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ///////////객체화////////////////////////
        mypage_navi = (TextView) findViewById(R.id.mypage_navi);
        ...
        mypage_navi.setTypeface(typeface_b);
        mypage_point.setTypeface(typeface_b);
        mypage_id.setTypeface(typeface_m);
        mypage_name.setTypeface(typeface_r);
        //////////////////클릭이벤트//////////////////
            ...
            public void onResponse(Call<MyPageResult> call, Response<MyPageResult> response) {
                if (response.isSuccessful()) {
                    if (response.body().message.equals("ok")) {
                        ...
                        mypage_point.setText(String.valueOf(response.body().result.point) + " P");
                    }
                } else {
        ...
        adapter.setAssetManager(getAssets());
