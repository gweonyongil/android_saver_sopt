...
public interface NetworkService {
    ...
    ///////////////////////////메시지////////////////////////////////////////////
    @GET("/message/{user_num}")
    Call<MessageResult> getMessage(@Path("user_num") String user_num);
    @GET("/message/{thing_num}")
    Call<MessageDetailResult> getDetailMessage(@Path("thing_num") String thing_num);
    @POST("/message")
