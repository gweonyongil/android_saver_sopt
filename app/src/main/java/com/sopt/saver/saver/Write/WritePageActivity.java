...
public class WritePageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //////////////////폰트 설정/////////////////////
        SetFontClass setFontClass = new SetFontClass(getAssets());
        add_info_et.setTypeface(setFontClass.getNotoSansRegular());
        title_et.setTypeface(setFontClass.getNotoSansBold());
        kind_et.setTypeface(setFontClass.getNotoSansRegular());
        product_et.setTypeface(setFontClass.getNotoSansRegular());
        price_et.setTypeface(setFontClass.getNotoSansRegular());
        url_et.setTypeface(setFontClass.getNotoSansRegular());
        want_et.setTypeface(setFontClass.getNotoSansRegular());
        upper_tv.setTypeface(setFontClass.getNotoSansRegular());
        title_tv.setTypeface(setFontClass.getNotoSansRegular());
        category_tv.setTypeface(setFontClass.getNotoSansRegular());
        kind_tv.setTypeface(setFontClass.getNotoSansRegular());
        product_tv.setTypeface(setFontClass.getNotoSansRegular());
        price_tv.setTypeface(setFontClass.getNotoSansRegular());
        url_tv.setTypeface(setFontClass.getNotoSansRegular());
        sub_tv.setTypeface(setFontClass.getNotoSansRegular());
        img_tv.setTypeface(setFontClass.getNotoSansRegular());
        add_info_tv.setTypeface(setFontClass.getNotoSansRegular());
        /////////버튼 카테고리 체크///////////////
        try {
...
//                    options.inSampleSize = 4; //얼마나 줄일지 설정하는 옵션 4--> 1/4로 줄이겠다
        ...
        guide1Dialog.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
        guide1Dialog.show();
    }
