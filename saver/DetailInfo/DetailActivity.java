...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pays_navi.setTypeface(typeface_b);
        pays_report.setTypeface(typeface_m);
        pays_h1.setTypeface(typeface_b);
        pays_id.setTypeface(typeface_r);
        pays_title.setTypeface(typeface_m);
        pays_price_txt.setTypeface(typeface_b);
        pays_price.setTypeface(typeface_r);
        pays_date_txt.setTypeface(typeface_b);
        pays_date.setTypeface(typeface_r);
        pays_where_txt.setTypeface(typeface_b);
        pays_where.setTypeface(typeface_r);
        pays_how_txt.setTypeface(typeface_b);
        pays_how.setTypeface(typeface_r);
        pays_add_txt.setTypeface(typeface_b);
        pays_add.setTypeface(typeface_r);
        pays_sub1.setTypeface(typeface_r);
        pays_sub2.setTypeface(typeface_r);
        /////////////////클릭 이벤트//////////////////////////////
        findViewById(R.id.paysuccess_msg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent message_intent = new Intent(DetailActivity.this, MessageActivity.class);
