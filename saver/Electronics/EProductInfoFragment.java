...
public class EProductInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /////////////////////////폰트 클래스////////////////////////////////
        setFontClass = new SetFontClass(context.getAssets());
        product_title_tv.setTypeface(setFontClass.getNotoSansMedium());
        product_writer_user_id_tv.setTypeface(setFontClass.getNotoSansRegular());
        product_time_tv.setTypeface(setFontClass.getNotoSansRegular());
        product_comment_num_tv.setTypeface(setFontClass.getNotoSansRegular());
        product_tv1.setTypeface(setFontClass.getNotoSansRegular());
        product_tv2.setTypeface(setFontClass.getNotoSansRegular());
        product_tv3.setTypeface(setFontClass.getNotoSansRegular());
        product_tv4.setTypeface(setFontClass.getNotoSansRegular());
        product_tv5.setTypeface(setFontClass.getNotoSansRegular());
        ////////////////////////////////////////////////////////////////////
