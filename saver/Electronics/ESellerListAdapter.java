...
public class ESellerListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        seller_method.setTypeface(setFontClass.getNotoSansRegular());
        seller_local.setTypeface(setFontClass.getNotoSansRegular());
        seller_period.setTypeface(setFontClass.getNotoSansRegular());
        return convertView;
    }
}
