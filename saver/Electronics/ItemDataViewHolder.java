...
public class ItemDataViewHolder extends RecyclerView.ViewHolder {
    ...
    public ItemDataViewHolder(View itemView){
        ...
        electronics_title_tv.setTypeface(setfontClass.getNotoSansMedium());
        electronics_kind_tv.setTypeface(setfontClass.getNotoSansRegular());
        electronics_product_tv.setTypeface(setfontClass.getNotoSansRegular());
        electronics_price_tv.setTypeface(setfontClass.getNotoSansRegular());
        electronics_count_tv.setTypeface(setfontClass.getNotoSansRegular());
        electronics_time_tv.setTypeface(setfontClass.getNotoSansRegular());
        electronics_period_tv.setTypeface(setfontClass.getNotoSansRegular());
        electronics_user_id_tv.setTypeface(setfontClass.getNotoSansRegular());
    }
