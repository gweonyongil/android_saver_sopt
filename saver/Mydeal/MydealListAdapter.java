...
public class MydealListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        mydeal_title.setTypeface(setFontClass.getNotoSansMedium());
        mydeal_subtitle.setTypeface(setFontClass.getNotoSansRegular());
        mydeal_product.setTypeface(setFontClass.getNotoSansRegular());
        mydeal_price.setTypeface(setFontClass.getNotoSansRegular());
        mydeal_time.setTypeface(setFontClass.getNotoSansRegular());
        mydeal_text6.setTypeface(setFontClass.getNotoSansRegular());
        mydeal_text7.setTypeface(setFontClass.getNotoSansRegular());
        /////////////클릭이벤트설정/////////////////////
