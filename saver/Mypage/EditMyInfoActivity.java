...
public class EditMyInfoActivity extends AppCompatActivity {
    ...
    private TextView ed_birth_t = null;
...
//        Toast.makeText(getApplicationContext(), id, Toast.LENGTH_SHORT).show();
        ...
        ed_birth_t = (TextView) findViewById(R.id.editinfo_birth_txt);
        ...
        ed_birth_t.setTypeface(typeface_r);
            ...
            public void onResponse(Call<PrevUpdataInfoResult> call, Response<PrevUpdataInfoResult> response) {
                if (response.isSuccessful()) {
                    if (response.body().message.equals("ok")) {
                        ...
                        updateInfoData.password2 = response.body().result.password2;
