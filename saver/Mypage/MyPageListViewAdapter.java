...
public class MyPageListViewAdapter extends BaseAdapter{
    ...
    public void setAssetManager(AssetManager assetManager)
    {
        ...
        typeface_r = Typeface.createFromAsset(assetManager, "fonts/NotoSansCJKkr-Regular.otf");
        typeface_m = Typeface.createFromAsset(assetManager, "fonts/NotoSansCJKkr-Medium.otf");
    }
        ...
        if(convertView == null){
            ...
            switch(viewType){
                case ITEM_VIEW_TYPE_SECTION:
                    ...
                    sectionTextView.setTypeface(typeface_m);
                ...
                case ITEM_VIEW_TYPE_STRS:
                    ...
                    itemTextView.setTypeface(typeface_r);
                ...
                case ITEM_VIEW_TYPE_NEXT:
                    ...
                    titleTextView.setTypeface(typeface_r);
                ...
                case ITEM_VIEW_TYPE_TOGG :
                    ...
                    toggleTextView.setTypeface(typeface_r);
