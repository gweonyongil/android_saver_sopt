        ...
        if(convertView == null){
            ...
            switch(viewType){
                case ITEM_VIEW_TYPE_SECTION:
                    ...
                    sectionTextView.setTypeface(Typeface.createFromAsset(parent.getContext().getAssets(), "fonts/NotoSansCJKkr-Medium.otf"));
                ...
                case ITEM_VIEW_TYPE_ACCOUNT:
                    ...
                    txtTextView.setTypeface(Typeface.createFromAsset(parent.getContext().getAssets(), "fonts/NotoSansCJKkr-Regular.otf"));
                    accountTextView.setTypeface(Typeface.createFromAsset(parent.getContext().getAssets(), "fonts/NotoSansCJKkr-Regular.otf"));
                    accountNumTextView.setTypeface(Typeface.createFromAsset(parent.getContext().getAssets(), "fonts/NotoSansCJKkr-Regular.otf"));
                ...
                case ITEM_VIEW_TYPE_NEXT:
                    ...
                    titleTextView.setTypeface(Typeface.createFromAsset(parent.getContext().getAssets(), "fonts/NotoSansCJKkr-Regular.otf"));
                ...
                case ITEM_VIEW_TYPE_MONEY:
                    ...
                    money_edit.setTypeface(Typeface.createFromAsset(parent.getContext().getAssets(), "fonts/NotoSansCJKkr-Regular.otf"));
                    moneyTextView.setTypeface(Typeface.createFromAsset(parent.getContext().getAssets(), "fonts/NotoSansCJKkr-Regular.otf"));
