...
public class SignUpAddinfoActivity extends AppCompatActivity {
    ...
    private TextView title, area, like, card, visa, tel, pay, text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        area = (TextView) findViewById(R.id.signup_area_title);
        like = (TextView) findViewById(R.id.signup_like_title);
        card = (TextView) findViewById(R.id.signup_card_title);
        visa = (TextView) findViewById(R.id.signup_visa_title);
        tel = (TextView) findViewById(R.id.signup_tel_title);
        text = (TextView) findViewById(R.id.signup_text_title);
        pay = (TextView) findViewById(R.id.signup_money_title);
        ...
        Typeface typeface_medium = Typeface.createFromAsset(getAssets(), "fonts/NotoSansCJKkr-Medium.otf");

        title.setTypeface(typeface_bold);
        signup_pay_edit.setTypeface(typeface_bold);
        area.setTypeface(typeface_regular);
        like.setTypeface(typeface_regular);
        card.setTypeface(typeface_regular);
        visa.setTypeface(typeface_regular);
        tel.setTypeface(typeface_regular);
        pay.setTypeface(typeface_regular);
        text.setTypeface(typeface_regular);

        area_edit.setTypeface(typeface_regular);
        like_edit.setTypeface(typeface_regular);
        card_edit.setTypeface(typeface_regular);
        visa_edit.setTypeface(typeface_regular);
        tel_edit.setTypeface(typeface_regular);
